...
bool TrustAccount::withDraw(double amount)
{
    if (counterPerYear < def_counterPerYear)
    {
        ...
        {
            std::cout << "Thrust Account " << SavingAccount::name << "Maximium Value withDraw" << std::endl;
            return false;
        }
    }
    else
    {
        std::cout << "Thrust Account " << SavingAccount::name << "Reach Maximium of withDraw Per Year" << std::endl;
        return false;
    }
}
